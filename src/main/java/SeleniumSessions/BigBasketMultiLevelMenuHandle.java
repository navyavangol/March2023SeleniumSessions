...
//		level4.click();
	...
	public static void muliLevelMenuHandling(By leve1Locator, String level2, String level3, String level4)
			throws InterruptedException {
		Actions act = new Actions(driver);
		act.moveToElement(getElement(leve1Locator)).perform();
		Thread.sleep(1500);
	...
	public static void muliLevelMenuHandling(By level1Locator, String level2, String level3)
			throws InterruptedException {
		Actions act = new Actions(driver);
