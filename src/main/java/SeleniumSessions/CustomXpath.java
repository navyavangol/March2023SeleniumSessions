...
public class CustomXpath {
	...
	public static void main(String[] args) {
		...
		// 1. absolute xpath - /html/body/div/div[2]/ul/li[4] - it will start from the
		// body
		// 2. relative xpath /custom xpath - using attributes,using xpath functions

		// htmltag[@attribute='value']
		// input[@name='username']
		// input[@id='input-firstname']- recommended
		// button[@type='submit']
		...
		// input[@name='username' and @placeholder='Username' and @class='oxd-input
		// oxd-input--active']
		...
		// when we use By.class here we need to pass the unique class name not required
		// to pass all the class names ,
		// but in xpath when we use class attribute, need to mention all the class names

		By e1 = By.xpath("//input[@class='form-control private-form__control login-email']");// valid
		By e2 = By.className("login-email");// valid
		By e3 = By.className("form-control private-form__control login-email");// invalid
...
//		<input id = "test_900">
		...
		// input[@type='email' and contains(@data-test-id,'email-input') and
		// @id='username']
		...
		// htmltag[contains(text(),'value') and contains(@attr1,'value') and
		// @attr2='value']
		// a[contains(text(),'Address') and contains(@href,'account/address') and
